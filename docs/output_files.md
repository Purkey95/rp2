...
This is a Ireland-specific tax-advisor-friendly report that can be understood by tax professionals (not necessarily specializing in crypto). The tax_report_ie.ods output file follows the same format as the [US variant](#tax-report-us-advisor-friendly-report).
