-- MonitorCLT core schema (SQLite reference store).
--
...
CREATE TABLE IF NOT EXISTS ingest_run (
    ...
    field_set       TEXT NOT NULL DEFAULT '[]',        -- JSON: fields seen, for drift detection
...
CREATE TABLE IF NOT EXISTS event (
    ...
    county          TEXT,
    natural_key     TEXT,
    record_version_id INTEGER REFERENCES record_version (id),
    parcel_id       TEXT,
    person_id       INTEGER,
    occurred_at     TEXT,                              -- valid time, if the source says
    observed_at     TEXT NOT NULL,                     -- system time
...
CREATE TABLE IF NOT EXISTS mention (
    ...
    county          TEXT NOT NULL,
    natural_key     TEXT NOT NULL,
    record_version_id INTEGER NOT NULL REFERENCES record_version (id),
    role            TEXT NOT NULL,                     -- decedent | owner | grantor | grantee | personal_rep | ...
    position        INTEGER NOT NULL DEFAULT 0,
    raw_name        TEXT NOT NULL,
    parsed          TEXT NOT NULL,                     -- JSON name parse
...
CREATE TABLE IF NOT EXISTS entity_match (
    ...
    left_mention_id INTEGER,
    right_mention_id INTEGER,
    person_id       INTEGER REFERENCES person (id),
    match_tier      TEXT NOT NULL,
    probability     REAL NOT NULL CHECK (probability >= 0 AND probability <= 1),
    features        TEXT NOT NULL DEFAULT '{}',        -- JSON feature -> value
    evidence        TEXT NOT NULL DEFAULT '[]',        -- JSON list, human-readable labels
    flags           TEXT NOT NULL DEFAULT '[]',
    gates           TEXT NOT NULL DEFAULT '{}',        -- JSON gate -> passed
...
CREATE TABLE IF NOT EXISTS quality_snapshot (
    ...
    rows_delta      INTEGER,
    parse_fail_rate REAL,
    blocked_out_rate REAL,
    rolling_precision REAL,
